"""
CourtAlpha Utilities
Shared helper functions for the Executive Front Office Suite.
Includes logging, formatting, and DB connection management.
"""
...
class DBManager:
    ...
    def get_connection(self):
        """Returns a thread-safe connection to the DuckDB database."""
        try:
...
def shrink_value(raw_val, sample_size, prior=0, lmbda=300):
    ...
    Shrinks raw values toward a prior (global average) when sample size is low.
    """
